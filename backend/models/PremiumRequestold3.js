...
const premiumRequestSchema = new mongoose.Schema(
  {
    ...
    // Filled in by the doctor after the live chat ends — deliberately called
    // a "recommendation / care plan", never a prescription: no drug names,
    // dosages, or medical directives, just guidance and next steps.
    recommendation: {
...
premiumRequestSchema.methods.toClientJSON = function () {
  ...
  return {
    ...
    recommendation: this.recommendation?.content ? this.recommendation : null,
